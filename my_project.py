...
#icon
#image_icon=Tk.Photoimage(files="google.png")
#root.iconphoto(False,image_icon)


#arrow
#arrow_image=Tk.PhotoImage(file="arrow.png")
#image_label=Label(root,image=arrow_image,width=15)
...
#first combobox
combo1=ttk.Combobox(root,values=languageV,font="Roboto 13",state="r")
...
#second combobox
combo2=ttk.Combobox(root,values=languageV,font="Roboto 13",state="r")
